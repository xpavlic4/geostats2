...
public class FragmentPacificO extends Fragment{
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState){
        ...
        btD11O.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                final Dialog d1 = new Dialog(FragmentPacificO.this.getActivity(), R.style.DialogContinents);
                d1.setCancelable(true);
                d1.setContentView(R.layout.dialog_pacific_o_maps);
                ...
                Picasso.with(FragmentPacificO.this.getActivity().getApplicationContext()).load(R.drawable.map_pacific_o).into(ivMap);
        ...
        if((metrics.widthPixels >= 600 && metrics.heightPixels >= 1000) || FragmentPacificO.this.getResources().getConfiguration().orientation == Configuration.ORIENTATION_LANDSCAPE)
        {
            ivMapBasic.setVisibility(View.VISIBLE);
            Picasso.with(FragmentPacificO.this.getActivity().getApplicationContext()).load(R.drawable.map_pacific_o).into(ivMapBasic);
