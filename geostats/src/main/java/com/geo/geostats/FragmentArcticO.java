...
public class FragmentArcticO extends Fragment{
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState){
        ...
        btD10O.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                final Dialog d = new Dialog(FragmentArcticO.this.getActivity(), R.style.DialogContinents);
                d.setCancelable(true);
                d.setContentView(R.layout.dialog_arctic_o);
        ...
        btD11O.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                final Dialog d1 = new Dialog(FragmentArcticO.this.getActivity(), R.style.DialogContinents);
                d1.setCancelable(true);
                d1.setContentView(R.layout.dialog_arctic_o_maps);
                ...
                Picasso.with(FragmentArcticO.this.getActivity().getApplicationContext()).load(R.drawable.map_arctic_o).into(ivMap);
        ...
        if((metrics.widthPixels >= 600 && metrics.heightPixels >= 1000) || FragmentArcticO.this.getResources().getConfiguration().orientation == Configuration.ORIENTATION_LANDSCAPE)
        {
            ivMapBasic.setVisibility(View.VISIBLE);
            Picasso.with(FragmentArcticO.this.getActivity().getApplicationContext()).load(R.drawable.map_arctic_o).into(ivMapBasic);
